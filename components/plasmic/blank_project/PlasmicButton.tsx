...
import sty from "./PlasmicButton.module.css"; // plasmic-import: HeCIsCYiAyA/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: YlU8Zc3M9wS/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 7TmMKrmqOUy/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__z3ROk)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__mllUr)}
                role={"img"}
              />
            ),
